...
export const metadata: Metadata = { title: "213 Airfryer im Vergleich", description: "Alle Airfryer filtern, sortieren und anhand verständlicher Produktdaten vergleichen." };
