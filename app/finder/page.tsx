...
export const metadata: Metadata = { title: "Airfryer-Finder", description: "Beantworte sechs einfache Fragen und erhalte passende Airfryer-Empfehlungen mit verständlicher Begründung.", alternates: { canonical: "/finder" } };
