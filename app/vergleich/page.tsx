...
export const metadata:Metadata={title:"Airfryer vergleichen",description:"Bis zu vier Airfryer übersichtlich nach Preis, Kapazität, Zonen, Leistung und Bewertung vergleichen."};
