...
export const metadata:Metadata={title:"Airfryer-Zubehör",description:"60 Zubehörprodukte übersichtlich nach Kategorien – mit transparenter Datenbasis und Amazon-Preislink.",alternates:{canonical:"/zubehoer"}};
